...
export const CONTROL_FIELDS: ControlField[] = [
  ...
  },
  {
    ...
    type: "enum",
    options: [
      { value: "C0", label: "C0 - 0A AC charging" },
      { value: "C1", label: "C1 - AC charging gear 1" },
      { value: "C2", label: "C2 - AC charging gear 2" },
      { value: "C3", label: "C3 - AC charging gear 3" },
      { value: "C4", label: "C4 - AC charging gear 4" },
      { value: "C5", label: "C5 - AC charging gear 5" },
      { value: "C6", label: "C6 - max AC charging" },
    ],
  },
  {
  ...
  },
  {
    ...
    min: 0,
    step: 1,
    hint: "Dessmonitor exposes this field as current_limit; the portal does not report a unit.",
  },
  {
